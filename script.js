const words = ["BIODIVERSITY", "HYDROPOWER", "SOLAR", "DEFORESTATION",  "METHANE",  "WILDLIFE",  "TRANSITION",  "INDIGENOUS",  "RENEWABLE",  "EQUITY"];
const gridSize = 15;
...
function sharePage() {
    if (navigator.share) {
        navigator.share({
            title: "Clean Energy for a Sustainable Tomorrow",
            text: "Learn about renewable energy and SDG 7 with this fun word search game!",
